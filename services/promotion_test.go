...
func TestPromotionCalculateDiscount(t *testing.T) {
	...
	cases := []testCase{
		{name: "applied 100", purchaseMin: 100, discountPercent: 20, amount: 100, exptected: 80},
		{name: "applied 200", purchaseMin: 100, discountPercent: 20, amount: 200, exptected: 160},
		{name: "applied 300", purchaseMin: 100, discountPercent: 20, amount: 300, exptected: 240},
		{name: "not applied 50", purchaseMin: 100, discountPercent: 20, amount: 50, exptected: 50},
	}
